  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        text: { type: "string", description: "Aim at the node whose visible text contains this, instead of at coordinates. For inputText this is the text to type, not a selector. Anything without whitespace is quoted for the device shell and accepted as-is; text that mixes whitespace with \" $ ` or \\ is refused because hdc's own quoting leaves those live, and perform_ui_action stays available for it." },
